...
export const preloadDashboard = () =>
  preloadChunk('route-dashboard', chunkLoaders.dashboard)
export const preloadPriceDetail = () =>
  preloadChunk('route-price-detail', chunkLoaders.priceDetail)
export const preloadApiDocs = () => preloadChunk('route-api-docs', chunkLoaders.apiDocs)
export const preloadPriceChart = () =>
  preloadChunk('feature-price-chart', chunkLoaders.priceChart)
export const preloadPriceTable = () =>
  preloadChunk('feature-price-table', chunkLoaders.priceTable)
export const preloadPriceHistoryTable = () =>
  preloadChunk('feature-price-history-table', chunkLoaders.priceHistoryTable)
export const preloadSettingsPanel = () =>
  preloadChunk('feature-preferences', chunkLoaders.settingsPanel)
export const preloadAlertPanel = () =>
  preloadChunk('feature-alerts', chunkLoaders.alertPanel)

export const LazyLanding = lazy(() =>
  preloadLanding().then((module) => ({ default: module.Landing })),
)
export const LazyDashboard = lazy(() =>
  preloadDashboard().then((module) => ({ default: module.Dashboard })),
)
export const LazyPriceDetail = lazy(() =>
  preloadPriceDetail().then((module) => ({ default: module.PriceDetail })),
)
export const LazyApiDocs = lazy(() =>
  preloadApiDocs().then((module) => ({ default: module.ApiDocs })),
)
...
export const LazyPriceTable = lazy(() =>
  preloadPriceTable().then((module) => ({ default: module.PriceTableView })),
)
...
export const LazyAlertPanel = lazy(() =>
  preloadAlertPanel().then((module) => ({ default: module.AlertPanel })),
)
