  ...
  return (
    <div>
      <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 gap-4">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">Price Oracle Dashboard</h1>
        ...
        <div className="flex flex-wrap items-center gap-2">
          <input
            ...
            className="px-3 py-1.5 text-sm rounded-lg border border-gray-700 bg-gray-800 text-gray-200 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-cyan-500 w-full sm:w-48"
          ...
          {!pricesLoading && prices.length > 0 && (
            ...
            >
              ...
              <span className="hidden sm:inline">{selectMode ? `Select (${selected.size})` : 'Select'}</span>
              <span className="sm:hidden">{selectMode ? `${selected.size}` : 'Sel'}</span>
            </button>
          )}
